sap.ui.define(
  ["sap/fe/core/AppComponent", "axon/warehouse/ops/ext/FeOverlayRelease"],
  function (AppComponent, FeOverlayRelease) {
    "use strict";
    ...
    return AppComponent.extend("axon.warehouse.ops.Component", {
      ...
      init: function () {
        ...
        FeOverlayRelease.watchUntilReleased(document.body, 40);
      },
      ...
      _onShellHashChange: function () {
        this._syncInboundRoute();
        FeOverlayRelease.watchUntilReleased(document.body, 20);
      },
